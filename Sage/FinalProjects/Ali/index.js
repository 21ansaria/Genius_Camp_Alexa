...
const handlers = {
    'LaunchRequest': function () {
      var speechOutput = "You will never win this game of rock paper scissors. I dare you to try. Choose one.";
      this.response.speak(speechOutput).listen("What would you like to do?");
      this.emit(':responseReady');
    },
    'RPSIntent': function () {
        var elephant = "<audio src='soundbank://soundlibrary/animals/amzn_sfx_elephant_03'/>";
        var speechOutput = elephant + "HAHA! I won, and you lost. You will never win!";
        this.response.speak(speechOutput).listen("What would you like to do?");
        this.emit(':responseReady');
    },
